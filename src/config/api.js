...
export const callFetchDetailUserActivityInteractionByActivityId = (
  activity
) => {
...
export const callUpsertUserActivityInteraction = (data) => {
  return axios.post(`/api/activities/user-activity-interaction/upsert/`, {
    ...data,
  });
};
...
export const callFetchActivityPackageByActivityIdAndDateLaunch = (query) => {
  return axios.get(
    `/api/activities/activities-packages/activity-and-date-launch/?${query}`
  );
};
...
export const callLocationSuggestions = (q, type) => {
  return axios.get("/api/locations/suggestions/", { params: { q, type } });
};
...
export const callGetHotels = ({
  ...
  if (stay_type) {
    params.append("stay_type", stay_type);
  }
...
export const callFetchDetailUserHandbookInteractionByHandbookId = (
  handbookId
) => {
...
export const callUpsertUserHandbookInteraction = (data) => {
  return axios.post(`/api/handbooks/user-handbook-interaction/upsert/`, {
    ...data,
  });
};
