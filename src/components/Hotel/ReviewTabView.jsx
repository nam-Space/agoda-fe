...
const ReviewTabView = () => {
    const [activeTab, setActiveTab] = useState('agoda'); // Default active tab
                ...
                return (
                    <div className="grid grid-cols-[20%_50%_30%] gap-6 mt-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mt-4">Điểm cao đối với Vũng Tàu</p>
                        </div>
    ...
    const renderProgressBar = (label, value, color) => {
        const percentage = (value / 10) * 100; // Calculate percentage based on max value of 10
        return (
