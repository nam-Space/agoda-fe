...
const GallerySection = ({ images = [] }) => {
    ...
    return (
        <div className="gallery-container relative bg-white w-full max-w-6xl mx-auto rounded-lg shadow-sm">
            {/* Floating Heart Icon */}
            <button
                onClick={toggleHeart}
            ...
            <div className="grid grid-cols-6 gap-6">
                ...
                <div className="col-start-3 col-end-7 h-[272px] grid grid-cols-3 grid-rows-2 gap-4">
