...
const CarIncomingTab = ({ currentTab, setCurrentTab }) => {
        ...
        if (user?.id && currentTab === ServiceTab.INCOMING) {
            handleGetPayments(
                `current=${meta.currentPage}&pageSize=${
                    ...
                    ServiceType.CAR
                }&min_pickup_datetime_car=${dayjs(Date.now()).format(
                    "YYYY-MM-DDTHH:mm:ss"
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="px-6 py-4 flex gap-4 justify-end border-t">
                                        <Popconfirm
                                            placement="leftTop"
                                            title={"Xác nhận hủy chuyến taxi"}
                                            description={
                                                "Bạn chắc chắn muốn hủy chuyến taxi?"
                                            }
                                            onConfirm={() =>
