    ...
    <div className="bg-white rounded-xl shadow border border-gray-200 flex flex-col h-full overflow-hidden transition-transform duration-200 hover:scale-105 hover:shadow-xl">
      ...
      <div className="flex-1 flex flex-col px-5 pt-4 pb-6 min-h-[350px]">
        ...
        <div className="flex items-start justify-between">
          <div>
            <a
              ...
              className="font-semibold text-blue-600 hover:underline text-base leading-tight"
            >
              {name}
            </a>
          ...
          <div className="text-right ml-2 min-w-[120px]">
            <div className="font-bold text-lg text-green-700">
              {score} <span className="font-normal text-gray-700">{reviewText}</span>
            </div>
          ...
          {showFull && fullSnippet ? (
            ...
            <>
              ...
              {fullSnippet && (
                ...
                >
                  Xem tiếp
                  <svg className="w-4 h-4 ml-1 text-blue-600 inline" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="mt-3 text-sm">
          ...
          {reviewerCountry && (
            <span className="text-gray-500">, {reviewerCountry}</span>
          )}
        </div>
      </div>
    </div>
