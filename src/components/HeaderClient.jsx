                                                    ...
                                                    <div className="flex-grow">
                                                        ...
                                                        <div>
                                                            <div className="flex items-center gap-[10px]">
                                                                <p className="font-semibold text-[14px] text-blue-600">
                                                                    Chiều đi:
                                                                </p>
                                                                <div className="flex items-center gap-[2px]">
                                                                    <img
                                                                        src={
                                                                            "http://localhost:8000/media/airline_logo_images/bamboo-airways.png"
                                                                        }
                                                                        alt={
                                                                            "Bamboo Airways"
                                                                        }
                                                        ...
                                                        <div className="mt-[14px]">
                                                            <div className="flex items-center gap-[10px]">
                                                                <p className="font-semibold text-[14px] text-red-600">
                                                                    Chiều về:
                                                                </p>
                                                                <div className="flex items-center gap-[2px]">
                                                                    <img
                                                                        src={
                                                                            "http://localhost:8000/media/airline_logo_images/vietravel-airline.png"
                                                                        }
                                                                        alt={
                                                                            "Vietravel Airlines"
                                                                        }
