    ...
    return (
        <div className="relative activity-slider bg-white rounded-lg p-4">
            ...
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-bold text-gray-800">Hoạt động không thể bỏ qua ở Hồ Chí Minh</h2>
            ...
            <div className="flex space-x-2 mb-4">
                ...
                <button className="bg-gray-200 text-gray-800 rounded-full px-4 py-2 text-sm">Gần khách sạn của quý khách</button>
